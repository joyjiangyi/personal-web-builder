...
> 好的！在我们聊内容之前，先帮我了解你想要什么感觉的网站——
>
> **选一个最接近你心里想法的风格：**
>
> A · **电影质感** — 暗色背景，戏剧光影，大字排版，有沉浸感和仪式感
> B · **创意插画风** — 明亮或奶油色底，插画/IP 形象主导，有温度但不幼稚
> C · **极简编辑感** — 大量留白，字体考究，内容主导，像独立杂志或设计工作室
> D · **科技感** — 深色背景，网格线或数据流，清晰有力，无装饰
> E · **温暖亲切** — 柔和色系，轻松但专业，亲近感强
> F · **奢华高端** — 深色或纯黑底，克制装饰，信任感和稀缺感
>
> 也可以说"A+C 的结合"或者用几个词描述你的感觉，我来判断。

用户选完风格后，后续所有设计决策（配色、字体、布局、动效强度）都以这个风格为基准。
...
**⑤ 参考网站（可选）**
> 有没有你喜欢的网站截图或链接？有的话发给我，我可以参考具体的排版或细节。没有也完全没关系，跳过即可。
...
### 验收通过后：Step 1 — 收集首帧参考图

验收 OK 后，**不直接给提示词**，先向用户要一张参考图：

> "网站跑起来了 🎬
>
> 在生成视频提示词之前，先给我一张参考图——可以是你喜欢的电影截图、摄影作品、或者任何让你觉得「这就是我想要的感觉」的画面。
>
> 有了这张图，提示词会更准，Kling 生成出来的视频也和你的网站更搭。"

**用户给了参考图后：** 观察图片的场景、光线、色调、氛围，把这些具体视觉信息融入提示词。

**用户说没有参考图：** 根据网站风格主动给 2-3 个首帧方向描述（场景 + 光线 + 镜头位置），让用户选一个或自由补充，再生成提示词。
